...
export default class {
    ...
    /**
     * Assert that an attribute has the expected value.
     * 
     * @param {any} wrapper to be searched 
     * @param {string} attributeName to be tested 
     * @param {string} expectedValue of the attribute
     */
    static assertAttributeValue(wrapper, attributeName, expectedValue, higherOrderComponent) {
        const selector = {};
